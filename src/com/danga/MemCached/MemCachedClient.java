...
public class MemCachedClient {
	...
	/**
	 * Gets SockIOPool instance
	 */
	protected SockIOPool getPool() {
	    return this.pool;
	}
	 ...
	 */
	protected void loadMulti( LineInputStream input, Map<String,Object> hm, boolean asString ) throws IOException {
	...
	protected Map stats( String[] servers, String command, String lineStart ) {
